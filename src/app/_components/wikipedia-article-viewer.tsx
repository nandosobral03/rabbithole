...
export const wikipediaStyles = `
  ...
  .wikipedia-article-content .mwe-math-element {
    display: inline-block;
    vertical-align: middle;
  }

  .wikipedia-article-content .mwe-math-fallback-image-inline {
    max-width: 100%;
    height: auto;
    margin: 0;
    vertical-align: middle;
  ...
  /* Dark mode math equation inversion */
  .dark .wikipedia-article-content .mwe-math-fallback-image-inline,
  .dark .wikipedia-article-content .mw-invert,
  .dark .wikipedia-article-content .skin-invert {
    filter: invert(1) hue-rotate(180deg);
  }

  /* Also handle media queries for dark mode preference */
  @media (prefers-color-scheme: dark) {
    .wikipedia-article-content .mwe-math-fallback-image-inline,
    .wikipedia-article-content .mw-invert,
    .wikipedia-article-content .skin-invert {
      filter: invert(1) hue-rotate(180deg);
    }
  }

  /* However, if we're explicitly in light mode, don't invert */
  .light .wikipedia-article-content .mwe-math-fallback-image-inline,
  .light .wikipedia-article-content .mw-invert,
  .light .wikipedia-article-content .skin-invert {
    filter: none;
  }

  /* Mathematical notation styling */
  .wikipedia-article-content .mwe-math-mathml-inline {
    display: none; /* Hide MathML, use fallback images */
  }

  .wikipedia-article-content .mwe-math-mathml-a11y {
    position: absolute;
  ...
  /* Ensure math elements are properly spaced */
  .wikipedia-article-content .mwe-math-element {
    margin: 0 0.1em;
  }

  /* Inline math should align properly with text */
  .wikipedia-article-content .mwe-math-fallback-image-inline {
